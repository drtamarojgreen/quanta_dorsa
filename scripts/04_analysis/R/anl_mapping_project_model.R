# ---
# title: "CBT Advocacy Data Modeling and Analysis"
# author: "Jules"
# date: "2025-10-27"
# ---
#
# Description:
# This script performs a detailed analysis of clinical trial data related to CBT.
# It includes spatial analysis of trial locations, retrieval of ACS data,
# text analysis of trial summaries, and a Monte Carlo simulation for economic
# evaluation.
#
# Inputs:
# - `ct_selected`: A data frame of selected clinical trials.
# - A Census API key stored in the environment variable CENSUS_API_KEY.
# - A CSV file with BRFSS state data, specified by BRFSS_STATE_CSV_PATH.
# - A CSV file with ICD-11 terms, specified by ICD11_TERMS_CSV_PATH.
#
# Outputs:
# - Generates choropleth maps of ACS and BRFSS data.
# - Creates data frames and visualizations of token analysis results.
# - Produces a data frame with the results of the Monte Carlo simulation.
#
# Dependencies:
# - `dplyr`
# - `purrr`
